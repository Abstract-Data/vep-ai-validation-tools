...
from vep_ai_validation_tools.core import get_version_info, hello_world
...
class TestIntegration:
    ...
    def test_import_package(self):
        ...
        assert hasattr(vep_ai_validation_tools, "__version__")
        assert hasattr(vep_ai_validation_tools, "__author__")
        assert hasattr(vep_ai_validation_tools, "__email__")

    def test_version_consistency(self):
        """Test that version is consistent across modules."""
        import vep_ai_validation_tools
        from vep_ai_validation_tools.core import get_version_info

        assert vep_ai_validation_tools.__version__ == get_version_info()["version"]
